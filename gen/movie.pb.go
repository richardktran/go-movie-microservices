...
type Metadata struct {
	...
	Desctiption string `protobuf:"bytes,3,opt,name=desctiption,proto3" json:"desctiption,omitempty"`
...
func (x *Metadata) GetDesctiption() string {
	if x != nil {
...
var file_movie_proto_rawDesc = []byte{
	...
	0x20, 0x0a, 0x0b, 0x64, 0x65, 0x73, 0x63, 0x74, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x03,
